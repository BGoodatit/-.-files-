...
brew_install_if_not_exists neofetch
brew_install_if_not_exists lolcat
brew_install_if_not_exists starship

# Create .zshrc file with specified configurations
cat > ~/.zshrc <<EOF
...
# Create .zprofile file with specified configurations
cat > ~/.zprofile <<EOF
#!/bin/zsh
